...
public abstract class AbstractGstParser implements PsiParser {

    private final Parser parser;
    private final Function<TreeNodeType, IElementType> treeNodeTypeMapper;

    public AbstractGstParser(Parser parser, Function<TreeNodeType, IElementType> treeNodeTypeMapper) {
        this.parser = parser;
